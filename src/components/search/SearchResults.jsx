        ...
        {sortedResults.map((card, index) => {
          ...
          return (
            <div 
              ...
              className="magic-card group bg-slate-800/50 border border-slate-700/50 rounded-xl p-3 hover:border-primary-500/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg"
            >
              <div className="relative rounded-xl overflow-hidden shadow-card hover:shadow-card-hover mb-3">
                {/* Enhanced card image with lazy loading and optimized quality */}
                <EnhancedCardImage
                  card={card}
                  context="GRID_VIEW"
                  aspectRatio="card"
              ...
              <div className="flex space-x-2">
                ...
                {onCardClick && (
                  <button
                    ...
                    className="flex-1 bg-green-500 hover:bg-green-600 text-white py-1.5 px-2 rounded-md text-xs font-semibold flex items-center justify-center space-x-1 transition-colors shadow-md hover:shadow-lg transform hover:scale-105 transition-transform duration-200"
