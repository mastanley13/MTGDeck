        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              {/* Tutorial Trigger with visible label for clarity on desktop */}
              <div className="hidden lg:flex">
                <button
                  onClick={() => startTutorial()}
                  className="px-3 py-2 rounded-lg text-slate-300 hover:text-white hover:bg-slate-700/50 transition-all duration-200 flex items-center space-x-2"
            ...
            <div className="xl:hidden flex items-center space-x-2">
              {/* Mobile: keep labeled entry in menu instead of icon-only in navbar */}
              <button
