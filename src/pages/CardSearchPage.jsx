...
const CardSearchPage = () => {
  ...
  return (
    <>
      <Seo 
        title="MTG Card Search – Find Magic: The Gathering Cards"
        description="Search through Magic: The Gathering's vast card library with advanced filters and real-time results."
      />
