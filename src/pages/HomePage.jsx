  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <div className="relative overflow-hidden rounded-xl mb-16">
        <div className="absolute inset-0 bg-gradient-to-r from-primary-600 to-secondary-700 opacity-90"></div>
        <div className="relative z-10 px-6 py-16 sm:px-8 sm:py-24 lg:py-32 text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6">
            ...
            <span className="block text-primary-200">Commander Decks</span>
          </h1>
          <p className="mt-6 max-w-lg mx-auto text-xl text-white opacity-90 mb-10">
            Create, optimize, and share your Magic: The Gathering decks with AI-powered recommendations
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link 
              to="/builder" 
              className="px-8 py-4 bg-white text-primary-700 rounded-lg font-semibold hover:bg-gray-100 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-1 duration-200"
            >
              Start Building
            </Link>
            <Link 
              to="/decks" 
              className="px-8 py-4 bg-primary-800 bg-opacity-40 text-white border border-white border-opacity-30 rounded-lg font-semibold hover:bg-opacity-50 transition-colors shadow-lg"
            >
              View Your Decks
            </Link>
          </div>
      ...
      <div className="max-w-7xl mx-auto mb-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white rounded-xl shadow-card p-6 transform transition duration-300 hover:shadow-card-hover hover:-translate-y-1">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Comprehensive Search</h3>
          ...
          <div className="bg-white rounded-xl shadow-card p-6 transform transition duration-300 hover:shadow-card-hover hover:-translate-y-1">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Deck Analytics</h3>
            <p className="text-gray-600">
      ...
      <div className="max-w-7xl mx-auto bg-gray-50 rounded-xl p-6 lg:p-10 shadow-sm mb-20">
        <h2 className="text-2xl font-bold text-center mb-6">Build Decks for Any Color Identity</h2>
      ...
      {/* CTA Section */}
      <div className="text-center py-12 my-10 bg-gradient-to-r from-secondary-600 to-secondary-800 rounded-xl shadow-lg">
        <h2 className="text-3xl font-bold text-white mb-6">Ready to Build Your Next Commander Deck?</h2>
        <p className="text-xl text-white opacity-90 mb-8 max-w-3xl mx-auto px-4">
          Join thousands of players using our AI-powered deck builder to create optimized Commander decks
        </p>
        <Link 
          to="/builder" 
          className="px-8 py-4 bg-white text-secondary-700 rounded-lg font-semibold hover:bg-gray-100 transition-colors shadow-lg inline-block"
        >
          Start Building Now
        </Link>
      </div>
