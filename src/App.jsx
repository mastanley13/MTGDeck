        ...
        <DeckProvider>
          <Router>
            <div className="app min-h-screen bg-theme-bg-primary">
              ...
              <footer className="bg-theme-bg-secondary text-theme-text-secondary py-8 mt-auto border-t border-theme-bg-tertiary">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  <div className="flex flex-col md:flex-row justify-between items-center">
                    <div className="mb-4 md:mb-0">
                      <h3 className="text-lg font-semibold mb-1 bg-gradient-accent bg-clip-text text-transparent">MTG Commander Deck Builder</h3>
                      <p className="text-sm text-theme-text-muted">Build better commander decks with AI assistance</p>
                    </div>
                    <div className="flex space-x-6">
                      <a href="https://github.com" className="text-theme-text-muted hover:text-theme-accent-blue transition-colors">
                      ...
                      <a href="https://twitter.com" className="text-theme-text-muted hover:text-theme-accent-purple transition-colors">
